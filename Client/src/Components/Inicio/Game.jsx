...
const styleCorrectText = {
  ...
  padding: 0,
  textShadow:
    " 0px 0px 5px #FFF77C, 0px 0px 8px #FFF327, 0px 0px 17px #FFEAD2, 0px 0px 17px #FFEAD2",
};
const styleIncorrectText = {
  color: "#fff",
  display: "grid",
  textAlign: "center",
  fontFamily: "Fjalla One",
  ...
  padding: 0,
  textShadow:
    "0px 0px 6px #FFDF00, 0px 0px 8px #FF8B01, 0px 0px 10px #FF0000, 0px 0px 10px #FF0000",
};
const syleButton = {
  border: "solid",
  borderColor: "#fff",
  ...
  return (
    <Container maxWidth="sm" sx={{ marginTop: "10%", marginBottom: "10%" }}>
      ...
      <div style={{ height: 55 }}>
        {correct === true ? (
          <Fade in={correct}>
            <p style={styleCorrectText}>CORRECTO</p>
          </Fade>
        ) : null}
        {incorrect === true ? (
          <Fade in={incorrect}>
            <p style={styleIncorrectText}>INCORRECTO</p>
          </Fade>
        ) : null}
      </div>
      <motion.div
        ...
        animate={control}
      >
        {actorsDB.actors.length <= 0 ? (
          <CircularProgress color="warning" />
        ) : (
          <img
            id="img"
            alt={random}
            src={actorsDB.actors[random].img}
            style={styleImg}
          />
        )}
      </motion.div>
      <div>
        ...
        >
          <label name="name" style={{ color: "#fff", margin: 10 }}>
            Adivina el nombre del actor:
          </label>
        </Typography>
        <input
          type="text"
